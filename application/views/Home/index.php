...
<section class="wn__product__area brown--color pt--80  pb--30">
	<div class="container">
		...
		<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
			...
			<?php if (date('m', $pb['tanggal_upload']) >= (date('m', time()) - 2)) : ?>
			<div class="product product__style--3">
				<div class="col-lg-3 col-md-4 col-sm-6 col-12">
					<div class="product__thumb">
						<a class="first__img" href="<?= base_url("Home/detailProduk/{$pb['id']}") ?>"><img src="<?= base_url() . 'uploadImg/' . $pb['gambar'] ?>" alt="product image"></a>
						<div class="hot__box">
							<span class="hot-label">Baru</span>
						</div>
					</div>
					<div class="product__content content--center">
						<h4><a href="single-product.html"><?= $pb['nama_produk']; ?></a></h4>
						<ul class="prize d-flex">
							<li>Rp. <?= number_format($pb['harga'], 0, ',', '.') ?></li>
						</ul>
						<div class="action">
...
<section class="wn__product__area brown--color pt--80  pb--30">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="section__title text-center">
					<h2 class="title__be--2">Produk <span class="color--theme">Promo</span></h2>
				</div>
			</div>
		</div>
		<!-- Start Single Tab Content -->
